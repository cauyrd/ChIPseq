...
bwa_bam.close()
blat_bam.close()
print "# of softclipping larger than "+sys.argv[2]+" trigging BLAT alignment is:", num_softclip
print "# of BALT realigned reads is:", num_blat
